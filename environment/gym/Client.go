// Package gym provides access to OpenAI Gym's environments through
// an HTTP server running on Python
package gym
...
// This file is taken from OpenAI's Gym HTTP Server repository:
...
func (c *Client) Step(id InstanceID, action interface{},
	render bool) (observation interface{}, reward float64, done bool,
	info interface{}, err error) {
	defer func() {
		if err != nil {
