...
func (d *DeepQ) TdError(t ts.Transition) float64 {
	...
	// action := int(d.behaviourPolicy.SelectAction().AtVec(0))
	...
	// nextAction := int(d.targetPolicy.SelectAction().AtVec(0))
